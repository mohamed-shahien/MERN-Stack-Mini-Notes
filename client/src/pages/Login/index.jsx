...
const Login = () => {
  ...
  return (
    <>
      <form onSubmit={handelSubmit} ref={loginRef} className="bg-white dark:bg-zinc-900 shadow-2xl rounded-2xl overflow-hidden border-4 border-blue-400 dark:border-blue-800 max-w-md mx-auto">
